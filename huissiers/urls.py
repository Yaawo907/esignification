...
urlpatterns = [
    ...
    path('rechercher/<uuid:uuid>/fiche/', views.fiche_identification_justiciable, name='fiche_justiciable'),
    ...
    path('inviter/<uuid:uuid>/supprimer/', views.supprimer_invitation_justiciable, name='supprimer_invitation'),
